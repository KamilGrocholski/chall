...
import { Config, generatePassword, getPasswordStrength, PASSWORD_STRENGTH, PasswordStrengthType } from "./utils";
  ...
  return (
    <div className="flex flex-row bg-pg-light px-3 py-3 justify-between">
      ...
      >
        {showCopy
          ? (
            <div className="absolute bottom-5 -left-16 border border-black/30 bg-pg-light border-pg-primary px-3 py-2">
              Copied!
            </div>
          )
          : null}
